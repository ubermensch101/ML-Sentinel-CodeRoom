...
df = pd.read_excel('../Excel Files/Bank Data.xlsx', usecols=['Growth in IT', 'Growth in Rev'], sheet_name=0)
...
plt.ylabel("Percentage increase in revenue over a period of two years")
